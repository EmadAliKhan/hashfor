...
const HeroSection = () => {
  return (
    // <div
    //   className="flex flex-wrap min-h-screen w-full text-white mt-5 "
    //   // style={{
    ...
    //         <button
    //           type="button"
    //           className="flex items-center gap-2 rounded-full gold-gradient-btn px-5 py-2 text-black font-medium shadow hover:opacity-90 hover:-translate-y-1 transition duration-200 ease-in-out"
    //         >
    //           Launch App
    //         </button>
    //         <button
    //           type="button"
    //           className="flex items-center gap-2 rounded-full border border-yellow-400 bg-black px-5 py-2 gold-text font-medium hover:text-white hover:-translate-y-1 transition duration-200 ease-in-out"
    //         >
    //           Learn More
    //         </button>
    //       </div>
