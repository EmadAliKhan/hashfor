  ...
  return (
    <div className="h-[400px] w-full flex justify-center items-center relative">
      ...
      <div className="absolute w-[250px] h-[250px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-float">
        <div className="absolute w-24 h-24 top-0 right-0 transform rotate-45 border border-hashfror-gold/30 rounded-lg backdrop-blur-lg bg-black/40"></div>
        <div className="absolute w-32 h-32 bottom-12 left-12 transform rotate-12 border border-hashfror-gold/30 rounded-lg backdrop-blur-lg bg-black/40"></div>
        <div className="absolute w-28 h-28 top-16 left-8 transform -rotate-12 border border-hashfror-gold/30 rounded-xl backdrop-blur-lg bg-black/40"></div>
      </div>
